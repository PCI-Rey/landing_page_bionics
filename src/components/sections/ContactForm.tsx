        ...
        >
          ...
          <h2
            ...
            style={{
              ...
              lineHeight: 1.1, color: "#0D0D0D", marginBottom: "1.5rem",
            }}
          >
            Contact Us &{" "}
            <span style={{
          ...
          <p style={{
            ...
            fontSize: "1.125rem", color: "#4B5563", lineHeight: 1.7,
          }}>
        ...
        <div style={{
          ...
          >
            ...
            <div style={{
              ...
              backgroundColor: "#FFFFFF",
              border: "1px solid #E8EDF5",
              borderLeft: "none", // Will use absolute bar
              borderRadius: 24,
              padding: "2.5rem",
              ...
              <div style={{
                ...
                {STATS.map((stat) => (
                  <div key={stat.label} style={{
                    ...
                    <div style={{
                      fontSize: "1.875rem", fontWeight: 800, marginBottom: "0.5rem",
                      background: "linear-gradient(135deg, #00D4AA, #4A6CF7)",
                      WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent",
                      backgroundClip: "text",
                    }}>
            ...
            {/* Trust signals */}
            <div style={{
              display: "flex", flexWrap: "wrap", gap: "1.5rem", paddingInline: "0.5rem",
            }}>
