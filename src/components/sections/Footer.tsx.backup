...
const SOCIAL_LINKS = [
  {
    name: "LinkedIn",
    href: "#",
    color: "#0077b5", // Brand color fallback, but user requested brand color on hover. The Bionics brand is Cyan/Blue/Purple. Let's use Cyan (#00D4AA)
...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <div className="container-bionics" style={{ paddingTop: "5rem", paddingBottom: "3rem" }}>
        <motion.div
        ...
        >
          ...
          >
            {/* ── Brand column ────────────────────────────── */}
            <motion.div variants={itemVariants} style={{ gridColumn: "span 2", minWidth: 0 }}>
              {/* Logo + brand name */}
              <a
                href="#"
              ...
              >
                ...
                <span
                  style={{
                    fontSize: "1.75rem", // Match navbar size
                    fontWeight: 800,
                    ...
                    backgroundClip: "text",
                    lineHeight: 1, // ensure no extra space below text
                ...
                {CONTACT_INFO.map(({ label, href, color, icon }) => (
                  <li key={label} style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                    ...
                    {href ? (
                      ...
                      <span style={{ fontSize: "1rem", color: "#4B5563" }}>{label}</span>
                    )}
                  </li>
                ))}
              </ul>
...
function SocialIcon({ social }: { social: typeof SOCIAL_LINKS[number] }) {
