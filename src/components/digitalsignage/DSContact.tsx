...
export default function DSContact() {
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    solution: "digital-signage", // pre-selected
    specialRequest: "",
  });
  ...
  return (
    <section
      id="contact"
      aria-labelledby="ds-contact-heading"
      style={{
        position: "relative",
        backgroundColor: "#FFFFFF",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Ready to transform your space with Bionics Digital Signage?
                ...
                >
                  ...
                  >
                    <motion.div variants={slideUpVariant}>
                      <FormLabel htmlFor="ds-fullName" required>
                        Full Name
                      </FormLabel>
                      <input
                        type="text"
                    ...
                    <motion.div variants={slideUpVariant}>
                      <FormLabel htmlFor="ds-companyName">
                        Company Name
                      </FormLabel>
                      <input
                        type="text"
                  ...
                  >
                    <motion.div variants={slideUpVariant}>
                      <FormLabel htmlFor="ds-email" required>
                        Email Address
                      </FormLabel>
                      <input
                        type="email"
                    ...
                    <motion.div variants={slideUpVariant}>
                      <FormLabel htmlFor="ds-phone">Phone Number</FormLabel>
                      <input
                        type="tel"
                        id="ds-phone"
                        name="phone"
                  ...
                  {/* Special Request */}
                  <motion.div variants={slideUpVariant}>
                    <FormLabel htmlFor="ds-specialRequest">
                      Tell Us About Your Project
                    </FormLabel>
                    <textarea
                      id="ds-specialRequest"
                      name="specialRequest"
                      value={formData.specialRequest}
                      onChange={handleChange}
                      onFocus={() => setFocused("specialRequest")}
                      onBlur={() => setFocused(null)}
                      placeholder="Describe your space, number of screens, or any special requirements..."
                      rows={4}
                      style={{
...
function FormLabel({
  ...
  return (
    ...
    >
      ...
      {required && (
        <span
          style={{ color: "#00D4AA", marginLeft: "0.3rem" }}
          aria-hidden="true"
        >
          *
        </span>
