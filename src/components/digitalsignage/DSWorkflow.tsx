...
const STEPS = [
  {
    ...
    title: "Consultation",
    description:
      "We assess your space, goals, and audience to recommend the best digital signage strategy for your business.",
  ...
  },
  {
    ...
    title: "Planning",
    description:
      "Our team designs a tailored content plan and system architecture aligned with your brand identity.",
    icon: <PlanningIcon />,
  },
  {
    id: "installation",
    ...
    title: "Installation",
    description:
      "Professional hardware setup and software deployment on all your screens with zero disruption.",
  ...
  },
  {
    ...
    title: "Aftersales",
    description:
      "Ongoing technical support, content updates, and performance monitoring to keep your displays running flawlessly.",
    icon: <AftersalesIcon />,
  },
] as const;
...
/* ════════════════════════════════════════════════════════════
   DS WORKFLOW
   ════════════════════════════════════════════════════════════ */
export default function DSWorkflow() {
  return (
    <section
      id="ds-workflow"
    ...
    >
      ...
      <style>{`
        .ds-workflow-desktop { display: block; }
        .ds-workflow-mobile  { display: none;  }

        @media (max-width: 767px) {
          .ds-workflow-desktop { display: none;  }
          .ds-workflow-mobile  { display: block; }
        }
      `}</style>
    </section>
  );
