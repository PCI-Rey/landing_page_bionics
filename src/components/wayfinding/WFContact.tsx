...
const STATS = [
  ...
  { value: "< 2wk", label: "Avg. Implementation" },
] as const;
...
const INPUT_FOCUS: React.CSSProperties = {
  ...
  boxShadow:
    "0 0 0 2px #4A6CF7, 0 8px 24px rgba(74,108,247,0.15), 0 0 12px rgba(0,212,170,0.10)",
};
...
export default function WFContact() {
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    solution: "wayfinding", // pre-selected
    specialRequest: "",
  });
  ...
  return (
    <section
      id="contact"
      aria-labelledby="wf-contact-heading"
      style={{
        position: "relative",
        backgroundColor: "#FFFFFF",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Tell us about your property and we&apos;ll design a wayfinding
            solution that elevates every visitor journey. Our team responds
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  width: 6,
                  background:
                    "linear-gradient(180deg, #00D4AA, #4A6CF7, #8B5CF6)",
                }}
              />
                  ...
                  >
                    <span
                      ...
                      style={{
                        ...
                        borderRadius: "50%",
                        background:
                          "linear-gradient(135deg, #00D4AA, #4A6CF7)",
                        display: "flex",
                        alignItems: "center",
                ...
                >
                  ...
                  >
                    <motion.div variants={slideUpVariant}>
                      <FormLabel htmlFor="wf-fullName" required>
                        Full Name
                      </FormLabel>
                      <input
                        type="text"
                    ...
                    <motion.div variants={slideUpVariant}>
                      <FormLabel htmlFor="wf-companyName">
                        Property / Company
                      </FormLabel>
                      <input
                        type="text"
                  ...
                  >
                    <motion.div variants={slideUpVariant}>
                      <FormLabel htmlFor="wf-email" required>
                        Email Address
                      </FormLabel>
                      <input
                        type="email"
                    ...
                    <motion.div variants={slideUpVariant}>
                      <FormLabel htmlFor="wf-phone">Phone Number</FormLabel>
                      <input
                        type="tel"
                        id="wf-phone"
                        name="phone"
                  ...
                  {/* Project description */}
                  <motion.div variants={slideUpVariant}>
                    <FormLabel htmlFor="wf-specialRequest">
                      Tell Us About Your Space
                    </FormLabel>
                    <textarea
                      id="wf-specialRequest"
                      name="specialRequest"
                  ...
                  >
                    ...
                    Bionics Solutions team for a wayfinding consultation and
                  ...
                  <motion.div variants={slideUpVariant}>
                    <button
                      ...
                      style={{
                        ...
                        boxShadow:
                          "0 8px 32px rgba(74,108,247,0.28), 0 4px 16px rgba(0,212,170,0.18)",
                        transition:
                      ...
                      onMouseEnter={(e) => {
                        ...
                        el.style.boxShadow =
                          "0 12px 40px rgba(74,108,247,0.38), 0 6px 20px rgba(0,212,170,0.26)";
                      }}
                      onMouseLeave={(e) => {
                        const el = e.currentTarget as HTMLButtonElement;
